...
const translations = {
  zh: {
    ...
    loanProjectTitle: "Loan Portfolio Risk & Profitability Dashboard",
    loanProjectBody:
    ...
    skillFinanceBody: "Credit risk, portfolio analysis, process improvement, reporting, stakeholder coordination",
